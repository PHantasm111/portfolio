...
const Developer = ({animationName = 'idle', ...props}) => {
    ...
    const group = useRef();
    const {nodes, materials} = useGLTF('/models/animations/ph-official.glb')

    const {animations: idleAnimation} = useFBX('/models/actions/waving.fbx');
...
useGLTF.preload('models/animations/ph-official.glb')
